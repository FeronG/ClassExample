#' Moving Average
#'
#' @description We created a function that calculates a moving average of a specified window width across a vector.
...
#' \item{Output}{output vector of the moving average}
#' @examples
